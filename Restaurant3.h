...
class Layout_Design{
	private:
        string design1,design2,design3,design4,design5; 
		string layout1,layout2,layout3,layout4;
	public:
...
class Equipment{
	...
	public:
		void Equipments(){
			...
			equipment1[6]="Walk-in cooler"; equipment1[7]="Freezer (either a chest, upright, or walk-in)"; equipment1[8]="Saut� pans";
			...
			equipment1[22]="Steam table"; equipment1[23]="Entr�e plates"; equipment1[24]="Pasta bowls"; equipment1[25]="Appetizer plates"; 
